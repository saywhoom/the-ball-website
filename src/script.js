...
//Light 1
const pointLight = new THREE.PointLight(0x69ff, 0.1)
...
const pointLight2 = new THREE.PointLight(0x5001e3, 2)

pointLight2.position.set(2.64,1,-0.41)
...
// light1.add(pointLight2, 'intensity').min(0).max(100).step(0.01)
...
pointLight3.position.set(-2.64,0.089,-0.41)
...
// light2.add(pointLight3, 'intensity').min(0).max(100).step(0.01)
...
const tick = () =>
{
    //using event listener to track mouse pos
    targetX = mouseX * .001
    targetY = mouseY * .001
